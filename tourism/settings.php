<?php
// ============================================================
// tourism/settings.php
// Tourism / Lodge Operator — Personal Account Settings
// ------------------------------------------------------------
// Sections:
//   - Profile Information (name, email, phone, lodge name)
//   - Change Password
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'update_preferences') {
        ...
        $onSaf   = isset($_POST['notify_safety_alerts'])    ? 1 : 0;
...
// ============================================================
// RECENT ACTIVITY (this user only)
// ============================================================
...
<head>
    ...
    <title>My Settings - Tourism - Wildlife Sentinel</title>
        ...
        <main class="main-content">
            ...
            <div class="content">
                <div class="dashboard-greeting">
                    <h1>👤 My Settings</h1>
                    <p>Manage your profile, password, and personal notification preferences.</p>
                </div>
                    ...
                    <div>
                            ...
                            <form method="POST">
                                ...
                                <div class="toggle-row">
                                    <div class="toggle-info">
                                        ...
                                        <div class="toggle-desc">General safety alerts in your zone.</div>
                                    </div>
                                    <label class="switch">
                                        <input type="checkbox" name="notify_safety_alerts" value="1" <?= (int)$prefs['notify_safety_alerts'] === 1 ? 'checked' : '' ?>>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                        ...
                        <div class="section" style="border-left:4px solid #cce5ff;background:#f8fbff;">
                            <div style="font-size:13px;color:#495057;line-height:1.7;">
                                <strong>💡 Tips for Tourism Operators</strong><br>
                                ...
                                • Report incidents immediately — the sooner rangers know, the safer everyone is.
                            </div>
                        </div>
                    </div>
                </div>
