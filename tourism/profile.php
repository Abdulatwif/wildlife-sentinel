...
$stmt = $pdo->prepare("
    SELECT 
        (SELECT COUNT(*) FROM incidents WHERE reporter_id = ? AND reporter_type = 'tourism') as reported_count,
...
<head>
    ...
    <title>Tourism Profile - Wildlife Sentinel</title>
...
<body>
            ...
            <div class="content">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-card">
                        ...
                        <div class="profile-role badge-warning">
    ...
    <script>
        document.querySelector('input[name="new_password"]')?.addEventListener('input', function() {
            ...
            const colors = ['#dc3545', '#ffc107', '#fd7e14', '#28a745', '#ffc107'];
        ...
        console.log('✅ Tourism Profile page loaded');
