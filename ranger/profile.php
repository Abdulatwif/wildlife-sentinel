...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_availability') {
        ...
        try {
            updateRangerAvailability($user['id'], $status);
            $success = $status ? '✅ You are now available for assignments.' : '❌ You are now unavailable.';
            logAudit($user['id'], 'update_availability', ['status' => $status]);
...
$stmt = $pdo->prepare("SELECT is_available FROM ranger_availability WHERE ranger_id = ?");
...
<head>
    ...
    <title>Ranger Profile - Wildlife Sentinel</title>
    ...
    <style>
        ...
        .profile-availability .status-dot {
            width: 10px;
            height: 10px;
            border-radius: 50%;
            display: inline-block;
        ...
        .profile-availability .status-dot.online { background: #28a745; }
        .profile-availability .status-dot.offline { background: #dc3545; }
...
<body>
            ...
            <div class="content">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-card">
                        ...
                        <div class="profile-availability <?= $isAvailable ? 'available' : 'unavailable' ?>">
                        ...
                        <form method="POST" style="margin-top:8px;">
                            ...
                            <button type="submit" class="btn <?= $isAvailable ? 'btn-danger' : 'btn-success' ?> btn-block">
    ...
    <script>
        ...
        document.querySelector('input[name="new_password"]')?.addEventListener('input', function() {
            ...
            const colors = ['#dc3545', '#ffc107', '#fd7e14', '#28a745', '#1a5c3a'];
        ...
        console.log('✅ Ranger Profile page loaded');
        console.log('👤 User: <?= $user['full_name'] ?>');
        console.log('📊 Reports: <?= $stats['reported_count'] ?? 0 ?>');
        console.log('✅ Availability: <?= $isAvailable ? 'Available' : 'Unavailable' ?>');
    </script>
</body>
</html>