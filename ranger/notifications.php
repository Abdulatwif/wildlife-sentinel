<?php
// ============================================================
// ranger/notifications.php
// Ranger — Notification Center
// ============================================================
...
<head>
    ...
    <title>Notifications - Ranger - Wildlife Sentinel</title>
        ...
        <main class="main-content">
            ...
            <div class="content">
                <div class="dashboard-greeting">
                    <h1>🔔 Notifications</h1>
                    <p>Stay informed about incidents, messages, and system alerts.</p>
                </div>
                        ...
                        <?php foreach ($notifications as $n): ?>
                            ...
                            <div class="notif-item <?= (int)$n['is_read'] === 0 ? 'unread' : '' ?>">
                                ...
                                <div class="notif-actions">
                                    ...
                                    <?php if (!empty($n['incident_id'])): ?>
                                        <a href="incidents.php" class="btn btn-sm btn-primary">👁️ View</a>
                                    <?php endif; ?>
